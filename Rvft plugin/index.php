<?php
/**
* Plugin Name: Rvft Plugin skärgårdinlägg
...
// Rubriker och knappar
	$labels = array(
		'name'				=> "Skärgård",
		'singular_name'		=> "Skärgård inlägg",
		'add_new'			=> "Lägg till ny",
		'add_new_item'		=> "Lägg till nytt skärgårdinlägg",
		'new_item'			=> "Lägg till ny skärgård",
		'all_items'			=> "Alla skärgårds inlägg",
		'view_items'		=> "Se alla skärgårdsinlägg",
		'search_items'		=> "Sök i Skärgård",
